...
data SuccessorNode a e = SuccessorNode {nodeRes::FetchResult e,
...
simpleNode :: FetchResult e -> a -> SuccessorNode a e
simpleNode r s = SuccessorNode r s id
...
voidNode = flip simpleNode undefined
...
reqNode r m = SuccessorNode r undefined m
