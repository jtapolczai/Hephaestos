...
data SuccessorNode a e = SuccessorNode {nodeState::a,
                                        -- ^The new state.
...
htmlSuccessor :: (Request -> Request) -- ^The request modifier function.
              ...
              -> HTMLSuccessor a [NetworkError]
              -> Successor a [NetworkError]
