...
downloadForest :: forall a resColl b.(Injective a String,
                   Co.Collection resColl (SuccessorNode SomeException b))
               => Manager
               ...
               -> resColl
               -> ErrorIO resColl
downloadForest m succ reqMod saveLocation inp = foldM fold' inp
   where
